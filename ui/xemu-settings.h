...
enum xemu_settings_keys {
    ...
    XEMU_SETTINGS_SYSTEM_XMU1_PATH,
    XEMU_SETTINGS_SYSTEM_XMU2_PATH,
    ...
    XEMU_SETTINGS_DISPLAY_CUSTOM_RATIO,
	...
	XEMU_SETTINGS_INPUT_CONTROLLER_1_LSDZ,
	XEMU_SETTINGS_INPUT_CONTROLLER_1_RSDZ,
	XEMU_SETTINGS_INPUT_CONTROLLER_2_LSDZ,
	XEMU_SETTINGS_INPUT_CONTROLLER_2_RSDZ,
	XEMU_SETTINGS_INPUT_CONTROLLER_3_LSDZ,
	XEMU_SETTINGS_INPUT_CONTROLLER_3_RSDZ,
	XEMU_SETTINGS_INPUT_CONTROLLER_4_LSDZ,
	XEMU_SETTINGS_INPUT_CONTROLLER_4_RSDZ,
	XEMU_SETTINGS_INPUT_DISABLE_RUMBLE,
	XEMU_SETTINGS_INPUT_ANA_DIG_SWITCH,
	XEMU_SETTINGS_INPUT_ANA_BUTTON_TPF,
...
struct deadzone_str_map {
	enum xemu_settings_keys lstick;
	enum xemu_settings_keys rstick;
};

extern const struct deadzone_str_map deadzone_map[5];
extern const enum xemu_settings_keys stick_offset_map[5];
